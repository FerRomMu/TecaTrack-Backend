...
class EntityNotFoundError(TecaTrackError):
    def __init__(self, entity_name: str, identifier: str):
        ...
        Parameters:
            ...
            identifier (str): The identifier of the missing entity; stored on the exception instance and included in the exception message.
        """
...
class EntityAlreadyExistsError(TecaTrackError):
    def __init__(self, entity_name: str, identifier: uuid):
        """
        Initialize an exception indicating that an entity with the given identifier already exists.
        ...
        Details:
            Stores `entity_name` and `identifier` as instance attributes and sets the exception message to
