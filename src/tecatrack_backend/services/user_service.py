...
class UserService:
    def __init__(self, repository: UserRepository):
        ...
        The provided repository is used to perform persistence operations for user-related actions.
        """
    ...
    async def create_user(self, user_create: UserCreate) -> User:
        ...
        Parameters:
            user_create (UserCreate): Data required to create the user, including email and other profile fields.
